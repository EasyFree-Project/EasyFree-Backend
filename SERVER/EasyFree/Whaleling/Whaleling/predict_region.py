...
class predict_region:
    ...
    def predict(self, doc):
        ...
        for i in region_dic.keys():
            # key terms 
            with open('C:/Users/ehhah/dev/NLP_workspace/EasyFree/EasyFree-Backend/SERVER/EasyFree/Whaleling/Whaleling/key_terms/region_{}_words.txt'.format(i), 'rb') as f:
                key_terms = pickle.load(f)

            # load models
            with open('C:/Users/ehhah/dev/NLP_workspace/EasyFree/EasyFree-Backend/SERVER/EasyFree/Whaleling/Whaleling/models/region_{}_model.bin'.format(i), 'rb') as f:
                model = pickle.load(f)
