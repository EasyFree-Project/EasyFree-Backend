...
class EmartSpider(scrapy.Spider):
    ...
    CATEGORY_LIST = ['6000095799', '6000095829', '6000095904', '6000095921', '6000096175', '6000096206', '6000096294', '6000096220']
    # 사과, 수박, 바나나, 레몬, 감자, 호박, 당근, 깻잎
    ...
    def parse(self, response, category_num, product_number):
        ...
        for image in images:
            img_url = 'http:%s'%image.replace('84.jpg','%s.jpg'%48)
            yield EmartSpider.EasyFree_DB.update('Product', 'url = "{}"'.format(img_url), "product_number = {}".format(str(product_number)))
